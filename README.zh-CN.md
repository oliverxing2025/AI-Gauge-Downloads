...
如果 AI Gauge 对你有帮助，欢迎 Star，也可以请我喝杯咖啡，支持后续维护。

<p align="center">
  <a href="assets/WeChatSupport.jpg"><img src="assets/WeChatSupport.jpg" alt="小奥的微信赞赏码" width="220"></a>
</p>

微信扫码赞赏，点击图片可查看大图。也可在应用的设置 → **打赏作者咖啡** 中打开赞赏码。

打赏完全自愿，所有功能均可免费使用，不打赏也不影响使用。独立开发者：**小奥**。
